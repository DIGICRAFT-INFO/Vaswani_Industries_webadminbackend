...
// Store uploads inside public/ so Next.js serves them as static files.
// This is the original working setup.
...
export function deleteFile(filePath) {
  try {
    const rel = filePath.startsWith('/uploads/') ? filePath : `/${filePath}`;
